...
const Navbar: React.FC = () => {
  return (
    <nav className="bg-gradient-to-b from-[#1E40AF] to-[#3B82F6] bg-opacity-90 text-white p-2 sm:p-6 fixed bottom-0 w-full flex justify-around flex-wrap md:flex-col md:h-screen md:top-0 md:left-0 md:w-auto md:items-start">
      <Link
        href="/"
        className="hidden md:block text-white hover:bg-blue-700 rounded-full"
        data-tooltip-id="home-logo"
      >
      ...
      <Link
        href="/"
        className="text-white p-3 hover:bg-blue-700 rounded-full"
        data-tooltip-id="home-icon"
      >
        <Home size={28} />
      </Link>
      {/* <ReactTooltip
      ...
      <Link
        href="#"
        className="text-white p-3 hover:bg-blue-700 rounded-full"
        data-tooltip-id="documents-icon"
      >
        <FileText size={28} />
      </Link>
      {/* <ReactTooltip
